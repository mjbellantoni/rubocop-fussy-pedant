...
require_relative 'fussy_pedant/rails/no_blank_line_between_scopes'
...
require_relative 'fussy_pedant/ruby/attr_shadowing_builtin'
require_relative 'fussy_pedant/ruby/comment_line_length'
require_relative 'fussy_pedant/ruby/consistent_array_coercion'
require_relative 'fussy_pedant/ruby/constant_definition_order'
require_relative 'fussy_pedant/ruby/initialize_assignment_order'
require_relative 'fussy_pedant/ruby/no_filter_guard_in_each'
require_relative 'fussy_pedant/ruby/no_namespace_assignment'
...
require_relative 'fussy_pedant/ruby/single_private_class_method'
